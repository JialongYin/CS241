 ...
 *
 * Note that when a user removes an element from the container this function is used.
*/
 ...
 *
 * Note that whenever a default value of an object is needed this function is used.
*/
