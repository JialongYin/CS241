...
void create_response(query *argp, char *ipv4_address, response *res) {
    ...
    res->address = (host_address *) calloc(1, sizeof(host_address));
    res->address->host = (char *) calloc(1, strlen(argp->host)+1);
    res->address->host_ipv4_address = (char *) calloc(1, MAX_BYTES_IPV4);
